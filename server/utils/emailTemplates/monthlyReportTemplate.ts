...
export const generateMonthlyExpenseEmail = async (recipientEmail: string, username: string) => {
  transporter
    .sendMail({
      from: `"Personal Finance" ${process.env.EMAIL_USERNAME}`, // sender address
      to: recipientEmail, // list of receivers
      subject: "Generated Monthly Report", // Subject line
      attachments: [
        {
          filename: "Logo.png",
                  ...
                  <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                            <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:rgb(255,255,255);">An expense report for the last month has been generated. Login to analyse your spending habits.</div>
                          </td>
                        </tr>
                        <tr>
